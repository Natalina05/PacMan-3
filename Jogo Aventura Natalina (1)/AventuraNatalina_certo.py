...
background = pygame.image.load("Teladefundo.png")
...
def main_menu():
    while True:
        ...
        draw_text('Aventura Natalina', font, (1, 37, 40), screen, 210, 130)
        mx, my = pygame.mouse.get_pos()

        # definições do botão 
        button_1 = pygame.Rect(200, 250, 200, 50)
        button_3 = pygame.Rect(200, 350, 200, 50)
      ...
      ## os três primeiros números entre parentes mudaram a cor e os dois últimos números mudaram a posição do texto dentro do botão
        draw_text('Jogar', font, (255, 255, 255), screen, 272, 265)
        draw_text('Sair', font, (255, 255, 255), screen, 278, 365)
...
def game():
        ...
        enemy_image = pygame.image.load('PapaiNoelFrente.gif')
        enemy_image = pygame.transform.scale(enemy_image, (70, 70))  # Redimensiona a imagem se necessario

        # Carregar a imagem do Pac-Man
        pac_image = pygame.image.load('Grinch_up_0.png')
        ...
        while running:
            ...
            # Criação do Pacman
                ...
                # Draw win message
                win_text = "Você venceu! Enter para jogar novamente"
                ...
                game_over_text = "Pressione Enter para jogar novamente"
                font = pygame.font.Font(None, 48)
