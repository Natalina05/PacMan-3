...
def main_menu():
    while True:
      ...
      ## os três primeiros números entre parentes mudaram a cor e os dois últimos números mudaram a posição do texto dentro do botão
        draw_text('Jogar', font, (255, 255, 255), screen, 272, 215)
        draw_text('Pontuação', font, (255, 255, 255), screen, 250, 315)
        draw_text('Sair', font, (255, 255, 255), screen, 278, 415)
        ...
        for event in pygame.event.get():
            if event.type == QUIT:
                pygame.quit()
                sys.exit()
            if event.type == KEYDOWN: ### Talvez modificar algo aqui, para voltar para tela de inicio ou precionar
        ...
        while running:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if game_state == GAME_STATE_WIN and event.key == pygame.K_ESCAPE:
